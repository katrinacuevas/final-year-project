...
class XpAward {
  static Future<void> show(BuildContext context, {required String lessonId, required int amount, Color? accentColor}) async {
    ...
    await showModalBottomSheet(
      ...
      builder: (_) => _XpSheet(
        amount: amount, accent: accent, alreadyAwarded: result == null,
...
class _XpSheet extends StatefulWidget {
  final int amount; final Color accent;
  final bool alreadyAwarded, levelledUp;
  final int newLevel, newXp, xpCeiling; final double xpProgress;
  const _XpSheet({required this.amount, required this.accent, required this.alreadyAwarded,
            ...
            child: Column(children: [
              ...
              AnimatedBuilder(
                ...
                builder: (_, __) => ClipRRect(
                  ...
                  child: LinearProgressIndicator(value: _barAnim.value, minHeight: 10,
