...
class PhishingCatButton extends StatefulWidget {
  ...
  const PhishingCatButton({
    ...
    this.accentColor = kPhishingAccent,
...
class _PhishingCatButtonState extends State<PhishingCatButton> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: widget.minHeight ?? (widget.showButton ? 180 : 130),
...
class PhishingNextButton extends StatelessWidget {
  ...
  final String label;
  final bool enabled;
  const PhishingNextButton({super.key, required this.onTap, this.label = 'Next →', this.enabled = true});
  @override
  Widget build(BuildContext context) => SizedBox(
    ...
    child: ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        disabledBackgroundColor: kPhishingCard, disabledForegroundColor: Colors.white24,
...
class PhishingLessonLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(children: [
    const Icon(Icons.chevron_right_rounded, color: kPhishingAccent, size: 16), const SizedBox(width: 4),
...
class PhishingInfoCard extends StatelessWidget {
  ...
  const PhishingInfoCard({super.key, required this.color, required this.emoji, required this.title, required this.body});
  @override
  Widget build(BuildContext context) => Container(
...
class PhishingTipBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(color: kPhishingAccent.withValues(alpha: 0.08), borderRadius: BorderRadius.circular(16),
...
class PhishingStepCard extends StatelessWidget {
  ...
  final Color color;
  const PhishingStepCard({super.key, required this.number, required this.emoji,
    required this.title, required this.body, required this.color});
  @override
  Widget build(BuildContext context) => Container(
    padding: const EdgeInsets.all(14),
    decoration: BoxDecoration(color: kPhishingCard, borderRadius: BorderRadius.circular(16),
...
class PhishingTappableStepCard extends StatelessWidget {
  ...
  final VoidCallback onTap;
  const PhishingTappableStepCard({super.key, required this.number, required this.emoji,
    required this.title, required this.body, required this.color,
...
class PhishingLinkRow extends StatelessWidget {
  ...
  final bool safe;
  const PhishingLinkRow({super.key, required this.label, required this.link, required this.safe});
  @override
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(children: [
      ...
      Expanded(child: Container(
        ...
        child: Text(link, style: GoogleFonts.fredoka(fontSize: 12, fontWeight: FontWeight.w700,
