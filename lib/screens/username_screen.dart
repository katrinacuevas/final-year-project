...
class _UsernameScreenState extends State<UsernameScreen>
  ...
  bool _looksUnsafe(String text) {
    ...
    final hasName = realNames.any((e) => lower.contains(e));
    final hasBirthday = RegExp(r'19|20|201').hasMatch(lower);
  ...
  String get _mascotSpeech {
    if (!_hasText) return "Psst! Every great detective\nneeds a secret codename...";
    if (_checking) return "Running identity check\nthrough HQ database...";
    if (_looksUnsafe(_ctrl.text.trim())) return "⚠️ Never use your real name!\nPick a cool codename instead!";
    if (_isAvailable == true) return "Identity confirmed! That\ncodename is all yours! 🕵️";
    if (_isAvailable == false) return "Another agent has that name!\nTry a different codename!";
    return "Looking good, agent!\nHit go when you're ready!";
  }
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: const Color(0xFF00D1FF).withOpacity(0.4)),
                        ),
                        child: Row(children: [
                      ...
                      child: AnimatedTextKit(
                        ...
                        animatedTexts: [
                          TypewriterAnimatedText(
                            'Every great detective needs a codename!',
                          ...
                          TypewriterAnimatedText(
                            'Pick something cool and mysterious!',
                            speed: const Duration(milliseconds: 80),
                          ),
                        ],
                      ),
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: const Icon(Icons.manage_accounts_rounded,
                                  color: Color(0xFF00D1FF), size: 22),
                            ...
                            children: _suggestions.map((e) {
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  delay: Duration(
                                      milliseconds: Random().nextInt(400)));
                            }).toList(),
                          ),
                        ],
                      ),
                  ...
                  SizedBox(
                    ...
                    child: AnimatedBuilder(
                      ...
                      child: ElevatedButton(
                        onPressed:
                            _hasText && _isAvailable != false && !_navigating
                                ? _next
                                : null,
