  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        const SizedBox(height: 10),
      _SummaryTile(emoji: '🎣', text: 'What phishing is and how it works'),
      _SummaryTile(emoji: '📧', text: 'How to spot fake emails and messages'),
      _SummaryTile(emoji: '🔗', text: 'How to check suspicious links safely'),
      _SummaryTile(emoji: '🛡️', text: 'What to do if you receive a phishing message'),
      _SummaryTile(emoji: '💬', text: '3 real-life chat simulation scenarios'),
        const SizedBox(height: 28),
        _NextButton(onTap: () => _finish(context), enabled: !claiming,
