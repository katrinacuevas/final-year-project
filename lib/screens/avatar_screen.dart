...
class _AvatarScreenState extends State<AvatarScreen> with TickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> avatars = [
    {'emoji': '🐱', 'name': 'Pixel Cat',    'desc': 'Puzzle-solving cyber expert',      'color': const Color(0xFFFFC857)},
    {'emoji': '🦊', 'name': 'Fox Agent',    'desc': 'Fast-thinking internet detective', 'color': const Color(0xFFFF8A65)},
    {'emoji': '🐸', 'name': 'Frog Scout',   'desc': 'Explorer of hidden secrets',       'color': const Color(0xFF81C784)},
    {'emoji': '🤖', 'name': 'Bot Defender', 'desc': 'Blocks sneaky scammers',           'color': const Color(0xFF4FC3F7)},
    {'emoji': '👾', 'name': 'Pixel Beast',  'desc': 'Elite cyber guardian',             'color': const Color(0xFF6C63FF)},
    {'emoji': '🐉', 'name': 'Data Dragon',  'desc': 'Guardian of secret info',          'color': const Color(0xFFEF5350)},
  ];
  ...
  @override
  void dispose() { glowCtrl.dispose(); super.dispose(); }
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xFF161B2E), borderRadius: BorderRadius.circular(14),
                      border: Border.all(color: const Color(0xFF00D1FF).withValues(alpha: 0.3)),
                    ),
                    child: const Icon(Icons.arrow_back_rounded, color: Color(0xFF00D1FF), size: 20),
                  ),
                ).animate().scale(),
                ...
                child: DefaultTextStyle(
                  ...
                  child: AnimatedTextKit(
                    ...
                    animatedTexts: [
                      ...
                      TypewriterAnimatedText('Each avatar has a unique cyber power!', speed: const Duration(milliseconds: 75)),
                ...
                child: Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    AnimatedSwitcher(
                      ...
                      child: Row(key: ValueKey(selectedIndex), children: [
                        AnimatedBuilder(
                          animation: glowAnim,
                          builder: (context, child) => Container(
                            decoration: BoxDecoration(shape: BoxShape.circle,
                              boxShadow: [BoxShadow(color: selectedColor.withValues(alpha: 0.45 * glowAnim.value), blurRadius: 28, spreadRadius: 2)]),
                            child: child,
                          ),
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: LinearGradient(colors: [selectedColor, const Color(0xFF0D1117)], begin: Alignment.topLeft, end: Alignment.bottomRight),
                              border: Border.all(color: selectedColor.withValues(alpha: 0.7), width: 2),
                            ),
                            child: Center(child: Text(selected['emoji'] as String, style: const TextStyle(fontSize: 40))),
                          ),
                        ),
                    ...
                    GridView.builder(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        return GestureDetector(
                          onTap: () { SoundService.playClick(); setState(() => selectedIndex = i); },
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: isSelected ? [BoxShadow(color: avColor.withValues(alpha: 0.3), blurRadius: 14, spreadRadius: 1)] : [],
                            ),
                            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                              AnimatedScale(
                                duration: const Duration(milliseconds: 250),
                                scale: isSelected ? 1.15 : 1.0,
                                child: Text(av['emoji'] as String, style: const TextStyle(fontSize: 34)),
                              ),
                              ...
                              if (isSelected)
                                Padding(
                                  ...
                                  child: Icon(Icons.check_circle_rounded, color: avColor, size: 14),
                                ).animate().scale(),
                            ]),
                  ...
                  child: ElevatedButton(
                    ...
                    child: saving
                        ...
                        : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text('Deploy Agent →', style: GoogleFonts.fredoka(fontSize: 22, fontWeight: FontWeight.w700)),
                          ]),
                  ),
                ),
              ).animate().fade().scale(),
