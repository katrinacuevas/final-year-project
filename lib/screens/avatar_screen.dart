                ...
                child: Column(
                  children: [
                    Row(children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: const Icon(Icons.arrow_back, color: Color(0xFF1A2E45), size: 20),
                        ),
                      ),
                      const Spacer(),
                      Container(
                    ...
                    AnimatedContainer(
                      ...
                      child: Center(child: Text(selected['emoji'] as String,
                    ...
                    Text(selected['name'] as String,
                      style: const TextStyle(fontSize: 13, color: Color(0xFF7A9BB5), fontWeight: FontWeight.w600)),
                    const SizedBox(height: 4),
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: isSelected ? const Color(0xFF4A90D9) : const Color(0xFFDDE8F2),
                              width: isSelected ? 2.5 : 1.5,
                            ),
                            boxShadow: isSelected
                              ? [BoxShadow(color: const Color(0xFF4A90D9).withOpacity(0.25), blurRadius: 12, offset: const Offset(0, 4))]
                              : [BoxShadow(color: Colors.black.withOpacity(0.04), blurRadius: 6, offset: const Offset(0, 2))],
                          ),
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(av['emoji'] as String, style: const TextStyle(fontSize: 32)),
                              const SizedBox(height: 4),
                              Text(av['name'] as String,
                                style: TextStyle(
                                  fontSize: 10,
                                  fontWeight: FontWeight.w700,
                                  color: isSelected ? const Color(0xFF1A2E45) : const Color(0xFF9AABBF),
                                )),
                              if (isSelected)
                                const Padding(
                                  padding: EdgeInsets.only(top: 3),
                                  child: Icon(Icons.check_circle, color: Color(0xFF4A90D9), size: 14),
                                ),
                            ],
                          ),
                        ),
